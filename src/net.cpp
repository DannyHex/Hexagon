...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Hexagon " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"hex-coin.com", "node.hex-coin.com"},
    {"hex-coin.com", "node2.hex-coin.com"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Hexagon is probably already running."), addrBind.ToString().c_str());
        else
